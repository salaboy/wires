...
public class TemplatesGroup extends Composite {
    ...
    private final ImmutableSet<String> filesNames = ImmutableSet.of( "dog-problem.xml03", "cancer.xml03", "asia.xml03", "car-starts.xml03", "elimbel2.xml03", "john-mary-call.xml03" );
    ...
    private void drawLayersExamples() {
        final Rectangle rectangle = new Rectangle( 10,
                                                   10 );
        rectangle.setX( 0 ).setY( 5 ).setStrokeColor( ShapesUtils.RGB_STROKE_SHAPE ).setStrokeWidth( ShapesUtils.RGB_STROKE_WIDTH_SHAPE ).setFillColor( ShapesUtils.RGB_FILL_SHAPE );
