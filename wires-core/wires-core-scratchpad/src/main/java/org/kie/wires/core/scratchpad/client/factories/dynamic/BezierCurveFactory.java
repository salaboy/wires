...
import org.kie.wires.core.scratchpad.client.shapes.dynamic.WiresBezierCurve;
...
public class BezierCurveFactory implements ShapeFactory<BezierCurve> {
    ...
    @Override
    public ShapeDragProxy<BezierCurve> getDragProxy( final ShapeDragProxyCallback callback ) {
        final BezierCurve curve = makeBezierCurve();
