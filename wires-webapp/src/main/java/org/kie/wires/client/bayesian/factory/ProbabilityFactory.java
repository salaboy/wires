...
public class ProbabilityFactory extends BaseFactory {
    ...
    public void init(BayesVariable node, Group group, Layer layer) {
        ...
        // draw parent node
        drawNodeSelected(node, positionX, positionY, width, height, group, layer);
        ...
        drawPorcentualOptions(node, positionXOptions, positionYOptions, widthOptions, heightOptions, group, layer);
        ...
        drawPorcentualValues(node, positionXValues, positionYValues, widthPorcentualValue, heightPorcentualValue, group, layer,
                positionYValues);
        ...
        drawIncomingNodes(node, positionXIncoming, positionYIncoming, widthIncoming, heightIncoming, group, layer,
    ...
    private void drawPorcentualValues(BayesVariable node, int positionXValues, int positionYValues, int widthPorcentualValue,
            int heightPorcentualValue, Group group, Layer layer, int positionY) {
    ...
    private void drawIncomingNodes(BayesVariable node, int positionXIncoming, int positionYIncoming, int widthIncoming,
            int heightIncoming, Group group, Layer layer, int widthPorcentualValue, int widthOptions, int heightOptions) {
    ...
    private void drawPorcentualIncoming(BayesVariable nod, int positionYIncoming, int heightIncoming, Group group, Layer layer,
