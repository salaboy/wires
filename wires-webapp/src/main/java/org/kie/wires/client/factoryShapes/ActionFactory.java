...
public class ActionFactory {
    ...
    public ActionFactory( Event<ClearEvent> clearEvent,
                          Event<ImageReadyEvent> imageReadyEvent ) {
    ...
    private void addAction( final int x,
                            final int y,
                            NodeMouseClickHandler clickEvent,
                            ImageResource img ) {
