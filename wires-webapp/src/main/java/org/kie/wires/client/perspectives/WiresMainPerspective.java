...
//        this.drawPanel(perspective, Position.SOUTH, WIRES_PROPERTIES_SCREEN);
    ...
    private void drawPanel( PerspectiveDefinition p,
                            Position position,
                            String identifierPanel ) {
        p.getRoot().insertChild( position, newPanel( p, position, identifierPanel ) );
    }

    private void createPanelWithChild( PerspectiveDefinition p,
                                       Position position ) {
    ...
    private PanelDefinition newPanel( PerspectiveDefinition p,
                                      Position position,
                                      String identifierPanel ) {
        final PanelDefinition panel = new PanelDefinitionImpl( PanelType.MULTI_LIST );
        panel.setWidth( WIDTH_PANEL );
